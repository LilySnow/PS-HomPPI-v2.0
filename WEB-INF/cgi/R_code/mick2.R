...
train_control <- trainControl(method = "repeatedcv", number=10, repeats = 1,    returnData = T,  savePredictions = "final")
...
model <- train(aveCC ~ ., data=data , trControl=train_control, method="rf", ntree = 400, tuneGrid=tunegrid ) #-- R-sq = 0.76, mtry = 1
