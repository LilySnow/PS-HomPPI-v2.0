...
sub validate_input {
    ...
    (my $email,my $jobtitle, my $jobID, my $qryIDpairs,my $qrySeqs,my $pdbFL_name,my $delLst,my $rasaThr,my $atomDistThr,my $safeMode_thr,my $twiMode_thr1,my $twiMode_thr2,my $twiMode_thr3,my $darkMode_thr,my $hhpred_param, my $flag_QryPDBFL, my $flag_rmSameProt) = @{shift @_};
...
#    my $paramTable = &getParamTableHTML(\@Params);
