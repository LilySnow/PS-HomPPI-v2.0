...
my @params_tmp = &getHTMLinput;

(my $email,my $jobtitle,my $qryIDpairs,my $qrySeqs,my $pdbFL_name,my $delLst,my $rasaThr,our $atomDistThr,our $safeMode_thr,our $twiMode_thr1,our $twiMode_thr2,our $twiMode_thr3,our $darkMode_thr,our $hhpred_param, my $flag_QryPDBFL, my $flag_rmSameProt) = @params_tmp;
...
my @params = (
    $jobtitle, $jobID, $email, $intDef, $atomDistThr,
